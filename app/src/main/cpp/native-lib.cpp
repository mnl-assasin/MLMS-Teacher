...
//node's libUV requires all arguments being on contguous memory.
extern "C" jint JNICALL
//Java_com_dapperwallet_dapperwallet_ui_activity_TestActivity_startNodeWithArguments(
//Java_com_dapperwallet_dapperwallet_ui_activity_SplashScreenActivity_startNodeWithArguments(
Java_com_jru_mlmsteacher_NodeJSServer_startNodeWithArguments(
        JNIEnv *env,
        jobject /* this */,
